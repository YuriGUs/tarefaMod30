...
public class ClienteDAOTest {
    ...
    public void pesquisarCliente() throws MaisDeUmRegistroException, TableException, TipoChaveNaoEncontradaException, DAOException {
        ...
        cliente.setEmail("rodrigo@example.com"); // Novo campo
    ...
    public void alterarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        clienteConsultado.setEmail("rodrigo.pires@example.com"); // Novo campo
        clienteDao.alterar(clienteConsultado);
        
        Cliente clienteAlterado = clienteDao.consultar(clienteConsultado.getCpf());
        Assert.assertNotNull(clienteAlterado);
        Assert.assertEquals("Rodrigo Pires", clienteAlterado.getNome());
        Assert.assertEquals("rodrigo.pires@example.com", clienteAlterado.getEmail()); // Novo campo
    ...
    public void buscarTodos() throws TipoChaveNaoEncontradaException, DAOException {
        ...
        cliente1.setEmail("rodrigo1@example.com"); // Novo campo
